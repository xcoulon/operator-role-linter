...
// pkg/apiresources/data/openshift-4.2.yaml
package data
...
var _apiresources_assetGo = []byte(``)
...
func openshift42YamlBytes() ([]byte, error) {
	return _openshift42Yaml, nil
}

func openshift42Yaml() (*asset, error) {
	bytes, err := openshift42YamlBytes()
	if err != nil {
		return nil, err
	}
...
var _bindata = map[string]func() (*asset, error){
	...
	"openshift-4.2.yaml":    openshift42Yaml,
}
...
var _bintree = &bintree{nil, map[string]*bintree{
	...
	"openshift-4.2.yaml":    &bintree{openshift42Yaml, map[string]*bintree{}},
}}
